...
class MainPanel:
    ...
    def show_main_panel(self):
        ...
        self.p1 = PhotoImage(file="Emoji1.png")
        self.p2 = PhotoImage(file="Emoji2.png")
        self.p3 = PhotoImage(file="Emoji3.png")
        self.p4 = PhotoImage(file="Emoji4.png")
        self.p5 = PhotoImage(file="Emoji5.png")
        self.p6 = PhotoImage(file="Emoji6.png")
        self.p7 = PhotoImage(file="Emoji7.png")
        self.p8 = PhotoImage(file="Emoji8.png")
        self.p9 = PhotoImage(file="Emoji9.png")
        self.p10 = PhotoImage(file="Emoji10.png")
        self.p11 = PhotoImage(file="Emoji11.png")
        self.p12 = PhotoImage(file="Emoji12.png")
        self.p13 = PhotoImage(file="Emoji13.png")
        self.p14 = PhotoImage(file="Emoji14.png")
        self.p15 = PhotoImage(file="Emoji15.png")
